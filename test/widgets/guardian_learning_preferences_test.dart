...
void main() {
  testWidgets('guardian can request slower pacing without curriculum-removal UI', (
    tester,
  ) async {
    ...
    expect(find.textContaining('do not directly remove required learning'), findsOneWidget);
  ...
  testWidgets('guardian can prioritize content timing when it becomes relevant', (
    tester,
  ) async {
