...
void main() {
  ...
  test(
    'external school record cannot create local role without identity evidence',
    () {
      expect(
        () => service.admit(
  ...
  test(
    'admitted roster role remains descriptive and grants no Mesh authority',
    () {
      ...
      expect(
        decision.admissionEvidenceIds,
        contains('source:roster:record:27'),
      );
