...
void main() {
  test('progress read uses consent-bound AXIOM action and opaque response', () async {
  ...
  test('identical progress reads use a deterministic request idempotency key', () async {
  ...
  test('unavailable learner-record provider propagates without local fallback', () async {
    final transport = _ProgressTransport(
