...
- Social Studies, Grades 1-6, and History and Geography, Grades 7-8 now has a metadata-only historical C1 snapshot bound to the current official DCP `elementary-sshg` route; Publications Ontario `233531` preserves the 2018 revised base lineage and Ontario's 2026-27 direction confirms new Grade 7-8 History learning;
...
- The Arts is the sole known uncaptured discovered English-language required-program source and retains a bounded capture target;
...
Seven C1 snapshots must not be described as seven-eighths product completion. Likewise, three strict recapture sources must not be described as a fraction of curriculum truth. These are different evidence dimensions, and Kindergarten is outside the Grades 1-8 required-program-family denominator used for the 7/8 English-language count. One SSHG source supplies evidence for two required program-family rows, which is why seven C1 source snapshots correspond to seven of eight English Grades 1-8 program families plus Kindergarten outside that denominator.
