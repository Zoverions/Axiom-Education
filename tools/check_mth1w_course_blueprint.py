...
def verify(
    ...
    expected_authored_paths = {
        ...
        "mth1w-u7": "curriculum/content/mth1w/u7-data-modelling.v1.json",
    }
    require(
        isinstance(authored_content, list) and len(authored_content) == 7,
        "exactly seven authored draft units must be declared at this milestone",
    )
