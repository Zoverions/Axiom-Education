...
- source-mapped offline MTH1W Units 1 through 5 with 18 full lessons, 36 worked examples, 198 practice items, five delayed-feedback quizzes with correction attempts, and transparent performance tasks;
...
- a machine-verified 9-unit, 43-lesson, 110-hour MTH1W blueprint covers every official expectation exactly once; Units 1 through 5 are authored offline drafts and the other four units remain unavailable;
