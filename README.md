...
- source-mapped offline MTH1W Units 1 through 3 with ten full lessons, 20 worked examples, 110 practice items, three delayed-feedback quizzes with correction attempts, and transparent performance tasks;
...
- a machine-verified 9-unit, 43-lesson, 110-hour MTH1W blueprint covers every official expectation exactly once; Units 1 through 3 are authored offline drafts and the other six units remain unavailable;
