...
- source-mapped offline MTH1W Units 1 through 4 with 15 full lessons, 30 worked examples, 165 practice items, four delayed-feedback quizzes with correction attempts, and transparent performance tasks;
...
- a machine-verified 9-unit, 43-lesson, 110-hour MTH1W blueprint covers every official expectation exactly once; Units 1 through 4 are authored offline drafts and the other five units remain unavailable;
