...
class _FocusBreakDialogState extends State<FocusBreakDialog> {
  ...
  static const _activities = [
    _BreakActivity(
      ...
      title: 'Walk Around',
      instruction:
          'Stand up and walk around the room for 2 minutes.\n'
    ...
    _BreakActivity(
      ...
      title: 'Quick Recall',
      instruction:
          'Without looking at your notes, write down 3 things\n'
  ...
  Widget build(BuildContext context) {
    ...
    final progress =
        1.0 - (_remaining / widget.breakDuration.inSeconds).clamp(0.0, 1.0);
